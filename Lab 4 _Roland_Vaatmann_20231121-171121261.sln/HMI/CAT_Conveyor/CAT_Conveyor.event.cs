...
#region Definitions;
#region #CAT_Conveyor_HMI;

namespace HMI.Main.Symbols.CAT_Conveyor
{
...
namespace HMI.Main.Symbols.CAT_Conveyor
{
  partial class sDefault
  {
    ...
    private event EventHandler<HMI.Main.Symbols.CAT_Conveyor.REQEventArgs> REQ_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (REQ_Fired != null)
          {
            try
            {
              REQ_Fired(this, new HMI.Main.Symbols.CAT_Conveyor.REQEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","REQ_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_CNF(HMI.Main.Symbols.CAT_Conveyor.CNFEventArgs ea)
    {
