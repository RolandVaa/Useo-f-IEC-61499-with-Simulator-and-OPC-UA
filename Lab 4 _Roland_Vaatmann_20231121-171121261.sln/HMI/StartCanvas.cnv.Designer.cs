...
this.currentUser1 = new NxtControl.GuiFramework.CurrentUser();
      ...
      this.canvasTopologySeparator2.Bounds = new NxtControl.Drawing.RectF(((float)(1160)), ((float)(0)), ((float)(2)), ((float)(80)));
    ...
    this.siblingsPanel.Bounds = new NxtControl.Drawing.RectF(((float)(199)), ((float)(0)), ((float)(961)), ((float)(80)));
    ...
    this.childrenPanel.Bounds = new NxtControl.Drawing.RectF(((float)(199)), ((float)(39)), ((float)(961)), ((float)(80)));
    ...
    this.childrenPanel.EndInit();
      ...
      this.exit1.Bounds = new NxtControl.Drawing.RectF(((float)(1240)), ((float)(0)), ((float)(40)), ((float)(40)));
      this.exit1.Text = "";
      this.exit1.Radius = 0;
      ...
      this.login1.Bounds = new NxtControl.Drawing.RectF(((float)(1160)), ((float)(0)), ((float)(40)), ((float)(40)));
      this.login1.Text = "";
      ...
      this.language1.Bounds = new NxtControl.Drawing.RectF(((float)(1200)), ((float)(0)), ((float)(40)), ((float)(40)));
